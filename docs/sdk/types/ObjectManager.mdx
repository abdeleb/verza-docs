...
> {
  ...
  attachToParent(parent: ObjectManager): void;
  ...
  setSound(
    soundName: string,
    options?: Omit<SoundOptions, 'objectId'>,
  ): import('../../../audio/sound.manager').default;

  removeSound(): void;

  setProximityAction(action: Omit<ProximityAction, 'id' | 'objectId'>): void;

  removeProximityAction(): void;

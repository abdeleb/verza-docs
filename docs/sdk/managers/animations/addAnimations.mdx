...
- [`AnimationInfo`](/sdk/types/AnimationInfo) - A promise that resolves to an array of `AnimationInfo` containing information about the animations that were added.

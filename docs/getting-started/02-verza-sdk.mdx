...
:::caution
Installing the **SDK** is only required if you're doing the connection manually. If you're using the [`Verza CLI`](/getting-started/setup-client-script#verza-create-cli), the **SDK** will be installed automatically.
:::

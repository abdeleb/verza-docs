...
5. **Add the script to your server:** Add the script to your server by going to the **Scripts** tab in your **Server's Settings**. Then, enter the URL of your script (`http://localhost:3000/client`) and click on `Connect Script`.

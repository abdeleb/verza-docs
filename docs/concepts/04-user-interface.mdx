...
To make your UI component visible, you can use the [`engine.ui.show`](/sdk/methods/ui/show) method. Additionally, you can customize the `size`, `position`, and `zIndex` of your UI component with the [`engine.ui.setSize`](/sdk/methods/ui/setSize) method, allowing you to organize and layer multiple UI elements from different scripts as needed.
...
| [`engine.ui.setSize`](/sdk/methods/ui/setSize) | Sets the size, position, and zIndex of the UI component. |

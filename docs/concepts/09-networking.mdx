...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------- |
| <ClientTag /> [`emitToPlayers`](/sdk/managers/network/emitToPlayers)                     | <ClientTag /> [`onPlayerEvent`](/sdk/managers/network/onPlayerEvent)               | Emits to all players                           |
| <ClientTag /> [`emitToPlayer`](/sdk/managers/network/emitToPlayer)                       | <ClientTag /> [`onPlayerEvent`](/sdk/managers/network/onPlayerEvent)               | Emits to a specific player                     |
| <ClientTag /> [`emitToServer`](/sdk/managers/network/emitToServer)                       | <ServerTag /> [`onPlayerEvent`](/sdk/managers/network/onPlayerEvent)               | Emits to the server                            |
| <ClientTag /> [`emitToPlayersWithAccess`](/sdk/managers/network/emitToPlayersWithAccess) | <ClientTag /> [`onPlayerEvent`](/sdk/managers/network/onPlayerEvent)               | Emits to all players with the specified access |
| <ClientTag /> [`emitToPlayersWithRoles`](/sdk/managers/network/emitToPlayersWithRoles)   | <ClientTag /> [`onPlayerEvent`](/sdk/managers/network/onPlayerEvent)               | Emits to all players with the specified roles  |
| <ClientTag /> [`emitToScripts`](/sdk/managers/network/emitToScripts)                     | <ClientTag /> [`onScriptEvent`](/sdk/managers/network/onScriptEvent)               | Only emits to local scripts                    |
| <ServerTag /> [`emitToPlayers`](/sdk/managers/network/emitToPlayers)                     | <ClientTag /> [`onServerEvent`](/sdk/managers/network/onServerEvent)               | Emits to all players                           |
| <ServerTag /> [`emitToPlayer`](/sdk/managers/network/emitToPlayer)                       | <ClientTag /> [`onServerEvent`](/sdk/managers/network/onServerEvent)               | Emits to a specific player                     |
| <ServerTag /> [`emitToPlayersWithAccess`](/sdk/managers/network/emitToPlayersWithAccess) | <ClientTag /> [`onServerEvent`](/sdk/managers/network/onServerEvent)               | Emits to all players with the specified access |
| <ServerTag /> [`emitToPlayersWithRoles`](/sdk/managers/network/emitToPlayersWithRoles)   | <ClientTag /> [`onServerEvent`](/sdk/managers/network/onServerEvent)               | Emits to all players with the specified roles  |
| <ServerTag /> [`emitToScripts`](/sdk/managers/network/emitToScripts)                     | <ClientTag /> <ServerTag /> [`onScriptEvent`](/sdk/managers/network/onScriptEvent) | Emits to all scripts, including client scripts |

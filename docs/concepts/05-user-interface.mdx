...
To make your UI component visible, you can use the [`engine.ui.show`](/sdk/managers/ui/show) method. Additionally, you can customize the `size`, `position`, and `zIndex` of your UI component with the [`engine.ui.setProps`](/sdk/managers/ui/setProps) method, allowing you to organize and layer multiple UI elements from different scripts as needed.
...
| Method                                            | Description                                              |
| ------------------------------------------------- | -------------------------------------------------------- |
| [`engine.ui.show`](/sdk/managers/ui/show)         | Makes the UI component visible.                          |
| [`engine.ui.hide`](/sdk/managers/ui/hide)         | Hides the UI component.                                  |
| [`engine.ui.setProps`](/sdk/managers/ui/setProps) | Sets the size, position, and zIndex of the UI component. |

...
First we need to create a new [`ParticlesManager`](/sdk/managers/#particlesmanager) manager using the [`EffectsManager`](/sdk/managers/#effectsmanager) manager.
...
See the [`ParticleOptions`](/sdk/types/ParticleOptions) type for a full list of options.
